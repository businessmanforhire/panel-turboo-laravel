            ...
            <div class="content-header row">
                ...
                <div class="content-header-right col-md-6 col-12">
                    <div class="btn-group float-md-right" role="group" >
                        <button class="btn btn-sm btn-amber"  type="button" data-toggle="modal" data-target="#add_category"><i class="ft-plus"></i> New Category</button>
                    </div>
                </div>
            </div>
                                ...
                                <div class="card-header">
                                    ...
                                    <div class="heading-elements">
                                        <ul class="list-inline mb-0">
                                                <li><button class="btn btn-sm btn-warning box-shadow-2 round btn-min-width pull-right" data-toggle="modal" data-target="#import" >Import Category</button></li>
                                        </ul>
                                        <!-- Modal -->
                                        <div class="modal fade text-left" id="add_category" tabindex="-1" role="dialog" aria-labelledby="myModalLabel9" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <form class="form" role="form" method="POST" action="{{route('subcategory.store',$cat_id)}}" enctype="multipart/form-data">
                                                    @csrf
                                        ...
                                        <div class="modal fade text-left" id="import" tabindex="-1" role="dialog" aria-labelledby="myModalLabel9" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <form class="form" role="form" method="POST" action="{{route('category.import',$cat_id)}}" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="modal-content">
                                                        <div class="modal-header bg-amber white">
                                                            <h4 class="modal-title white" id="myModalLabel9"><i class="la la-plus"></i> Add Category</h4>
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="col-md-12">
                                                                <div class="card">
                                                                    <div class="card-content collapse show">
                                                                        <div class="card-body">
                                                                            <a href="{{route('export_category_format')}}"><span class="ft ft-arrow-down"></span>Click here to download format</a>
                                                                            <br><br>
                                                                            <div class="form-body">
                                                                                <div class="form-group">
                                                                                    <div class="position-relative has-icon-left">
                                            ...
                                            <table class="table table-striped table-bordered zero-configuration">
                                                ...
                                                @foreach($categories as $category)
                                                    <tr>
                                                        <td>{{$category->name}}</td>
                                                        <td>
                                                            @if (file_exists(public_path('storage/images/category/'.$category->image)))
                                                                <img src="{{asset('storage/images/category/'.$category->image)}}" style="width:50px;height: 50px"  class="img-responsive" alt="">
                                                            @else
                                                        ...
                                                        <td> <b>Created at: </b>{{date('d-M-Y',strtotime($category->created_at))}}<br>
                                                            <b>Updated at:</b> {{date('d-M-Y',strtotime($category->updated_at))}}</td>
                                                        ...
                                                        <td>
                                                            <div class="form-group">
                                                                ...
                                                                {{--<button type="button" class="btn btn-icon btn-primary btn-lighten-1 btn-sm" data-toggle="modal" data-target="#edit_user{{$category->id}}"><i class="la la-edit"></i></button>--}}
                                                            </div>
                                                        </td>
                                                        <div class="modal fade text-left" id="edit_cat{{$category->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
                                                            <div class="modal-dialog" role="document">
                                                                <form class="form" role="form" method="POST" action="{{route('category.update',$category->id)}}" enctype="multipart/form-data">
                                                                    @csrf
                                                                    <div class="modal-content">
                                                                                            ...
                                                                                            <div class="form-body">
                                                                                                ...
                                                                                                <div class="form-group">
                                                                                                    <select  class="form-control square" name="visible" required>
                                                                                                        ...
                                                                                                        <option value="{{\App\Category::visible}}" {{$category->visible==\App\Category::visible ?'selected':''}} >Visible</option>
                                                                                                        <option value="{{\App\Category::not_visible}}" {{$category->visible==\App\Category::not_visible ?'selected':''}} >Not Visible</option>
                                                                                                    </select>
                                                                                                </div>
                                                                                                <div class="form-group">
                                                                                                    <div class="upload-btn-img">
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            <button type="button" class="btn grey btn-outline-secondary" data-dismiss="modal">Close</button>
                                                                            <a href="{{route('category.delete', $category->id)}}" type="submit" class="btn btn-outline-danger">Delete</a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
