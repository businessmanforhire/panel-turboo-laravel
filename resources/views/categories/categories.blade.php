                                    ...
                                    <div class="heading-elements">
                                        ...
                                        <div class="modal fade text-left" id="add_user" tabindex="-1" role="dialog" aria-labelledby="myModalLabel9" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <form class="form" role="form" method="POST" action="{{route('category.store')}}" enctype="multipart/form-data">
                                                    @csrf
                                            ...
                                            <table class="table table-striped table-bordered zero-configuration">
                                                ...
                                                @foreach($categories as $category)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button type="button" class="btn btn-sm btn-outline-primary round">  {{\App\BusinessCategory::where('id',$category->business_category_id)->value('name')}}</button>
                                                        </td>
                                                        <td>
