                            ...
                            <div class="card">
                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        <form action="{{route('push.store_individ')}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                                            @csrf
                                            <div class="form-body">
                                                <div class="form-group row">
                                                    <label class="col-md-3 label-control" for="user">User *</label>
                                                    <div class="col-md-5">
                                                        <select id="user" name="user" class="select2 form-control" required>
