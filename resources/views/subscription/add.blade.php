                            ...
                            <div class="card">
                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        <form action="{{route('subscription.store')}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                                            @csrf
                                            <div class="form-body">
                                                <div class="form-group row">
                                                    <label class="col-md-3 label-control" for="name">Title *</label>
                                                    <div class="col-md-5">
                                                        <input type="text" id="name" class="form-control" placeholder="Title" required name="title">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-5">
                                                        <input type="number" min="1" id="price" class="form-control" placeholder="Price" required name="price">
                                                    </div>
                                                </div>
