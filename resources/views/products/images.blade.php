                           ...
                           <div class="col-xl-3 col-md-6 col-sm-12">
                                    <div class="card">
                                        <div class="card-content">
                                            <img class="card-img-top img-fluid" src="{{asset('storage/images/products/'.$image->image)}}" alt="product_image">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="{{route('delete_image', $image->id)}}" type="submit" class="btn btn-outline-danger">Delete</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
