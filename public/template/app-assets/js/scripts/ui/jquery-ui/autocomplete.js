...
$(document).ready(function(){
	...
	************************************/
    ...
    $(".ac-remote-datasource").autocomplete({
        source: "../../../app-template/data/jquery-ui/search.php",
        minLength: 2
    });
    ...
    $(".ac-remote-caching").autocomplete({
        ...
        source: function(request, response) {
            ...
            $.getJSON("../../../app-template/data/jquery-ui/search.php", request, function(data, status, xhr) {
                cache[term] = data;
                response(data);
            });
        }
    ...
    .autocomplete({
        source: function(request, response) {
            $.getJSON("../../../app-template/data/jquery-ui/search.php", {
    ...
    // XML Data Pasing
    $.ajax({
        url: "../../../app-template/data/jquery-ui/london.xml",
        dataType: "xml",
