...
(function (window, document, $) {
  ...
  $('#select').change(function () {
    ...
    stylesheet.attr('href', '../../../app-template/vendors/css/editors/theme/' + selectedTheme.toLowerCase() + '.css');
  ...
  CodeMirror.modeURL = "../../../app-template/vendors/js/editors/codemirror/mode/*/*.js";
